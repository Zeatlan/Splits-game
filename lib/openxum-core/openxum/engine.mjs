...
class Engine {
  constructor() {
    ...
    if (this.build_move === Engine.prototype.build_move) {
      throw new TypeError("Please implement abstract method build_move.");
    }
  ...
  build_move() {
    throw new TypeError("Do not call abstract method build_move from child.");
  }
